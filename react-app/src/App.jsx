...
import { domain7StudyMaterials } from './data/domain7StudyMaterials'
import { domain8StudyMaterials } from './data/domain8StudyMaterials'
...
function App() {
  ...
  if (showStudyMaterials && selectedDomain?.id === 7) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 p-8">
        <StudyMaterials
          studyData={domain7StudyMaterials}
          domainName={selectedDomain.name}
          onBack={handleBackToMain}
        />
      </div>
  ...
  if (showStudyMaterials && selectedDomain?.id === 8) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 p-8">
        <StudyMaterials
          studyData={domain8StudyMaterials}
          domainName={selectedDomain.name}
          onBack={handleBackToMain}
        />
      </div>
